        ...
        <div class="row" id="divEquipmentArea">
            <div id="divEquipmentInfoBlock" class="col-xs-12 col-lg-8 push-down">
                <div class="info-block m-r-0 m-b-1" style="padding: 2px">
                    <fieldset>
                        <span class="pull-xs-right">
                            <button id="buttonlnkAddFLocation" class="btn btn-mini btn-primary" runat="server" enableviewstate="false" onclick="ViewAdditionalInfoLinks('L'); return false;"><%=GetGlobalResourceObject("Equipment_Resource", "addViewFunctionalLoc")%></button>
                            <button id="buttonlnkMeasuringPoint" class="btn btn-mini btn-success" runat="server" enableviewstate="false"  onclick="ViewAdditionalInfoLinks('P'); return false;" data-bind="visible: (EquipmentInfoArray().length > 0 || addEquipmentViewModel.EquipmentID() > 0) ? true : false"><%=GetGlobalResourceObject("Equipment_Resource", "addViewMeasuringPoint")%></button>
                            <button id="buttonlnkDocuments" class="btn btn-mini btn-info" runat="server" enableviewstate="false" onclick="ViewAdditionalInfoLinks('D'); return false;" data-bind="visible: (EquipmentInfoArray().length > 0 || addEquipmentViewModel.EquipmentID() > 0)? true : false"><%=GetGlobalResourceObject("Equipment_Resource", "addViewDocumentnAndImages")%></button>
                        </span>
                    </fieldset>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-lg-7 col-xl-8 p-l-0"> 
                    <fieldset class="heading-gap">
                        ...
                        <div class="col-xs-12 col-lg-7 p-a-0">
                            ...
                            <i class="fa fa-barcode tiny-rightmargin cursor-pointer pover pull-xs-left" data-bind="visible: EquipmentCode() != '' ? true : false" onclick="DownloadBarcode();return false;" data-content="<%=GetGlobalResourceObject("Equipment_Resource", "downloadBarcode")%>" data-placement="top" data-original-title="" style="font-size:2.2rem;"></i>
                            <a class="btn  btn-sm pull-xs-left btn-primary" data-bind="visible: ($root.HasEditAccess) ? BtnGenerateCode : false, click: function () { GenerateEquipmentCode() }"><span><%=GetGlobalResourceObject("Equipment_Resource", "generateCode")%></span></a>
                            <a class="btn btn-cancel btn-sm" data-bind="visible: ($root.HasEditAccess) ? !BtnGenerateCode() : false, click: function () { ClearGenerateEquipmentCode() }"><span><%=GetGlobalResourceObject("Equipment_Resource", "clearCode")%></span></a>                            
                    ...
                    <fieldset class="bottom-gap ">
                        ...
                        <textarea id="txtDescription" data-bind="textInput: EquipmentDesc, attr: { onkeydown: 'return checkTextAreaMaxLength(this,event,1000)' }" class="form-control-lg font-small col-xs-12 col-lg-7" style="min-height: 60px"></textarea>
                    </fieldset>
                     <fieldset>
                        ...
                        <fieldset class="col-xs-12 col-lg-7 p-x-0">
                            <select class="form-control-sm nopadding select2" id="drpEquipment" 
                                data-bind="options: ParentEquipmentList, optionsText: 'EquipmentName', optionsValue: 'EquipmentID', value: SelectedParentEquipment, event: { change: (DrpDownFunctionalLocationFlag() == true && SelectedParentEquipment() != undefined) ? function () { SelectFunctionalLocation() } : '' }">
                            </select>
                        </fieldset>
                    </fieldset>
                    <fieldset>
                    ...
                    <div class="col-xs-12 col-lg-12 p-l-0">
                        <label class="form-control-label col-xs-12 col-lg-6 col-xl-5"><%=GetGlobalResourceObject("Equipment_Resource", "authorizationGroup")%></label>                        
                ...
                <div id="divModelInfo" runat="server" enableviewstate="false" class="col-xs-12 col-sm-12 col-lg-7 col-xl-8 p-x-0">
                    ...
                    <fieldset>
                        <fieldset class="col-xs-12 p-l-0"  data-bind="visible: ModelName().length > 0 ? true : false ">
                            <label class="form-control-label col-xs-12 col-lg-5"><%=GetGlobalResourceObject("Equipment_Resource", "modelName")%></label>
                            <label data-bind="html: ModelName" class="form-control-label col-xs-12 col-lg-7 bold gray "></label>
                        </fieldset>
                        ...
                        <fieldset class="col-xs-12 p-l-0">
                            ...
                            <div class="col-xs-12 col-lg-7 p-a-0">
                                ...
                                <i class="fa blue cursor-pointer fa-plus-circle fa-2x pull-xs-right" onclick="javascript:ShowAddMaintenanceTypeModal('MANUFACTURER' , this);" title="Add/Edit Manufacture"></i>
                            </div>
                        </fieldset>
                    </fieldset>
                    <fieldset>
                        ...
                        <fieldset class="col-xs-12 p-l-0">
                            ...
                            <div class="col-xs-12 col-lg-7 p-a-0">
                                ...
                                <i class="fa blue cursor-pointer fa-plus-circle fa-2x pull-xs-right" onclick="javascript:ShowAddMaintenanceTypeModal('TYPE', this);" title="Add/Edit Type"></i>
                            </div>
                        </fieldset>
                    </fieldset>
                    <fieldset class="col-xs-12 p-l-0">
                        ...
                        <div class="col-xs-12 col-lg-7 p-a-0">
                            ...
                            <i class="fa blue cursor-pointer fa-plus-circle fa-2x pull-xs-right" onclick="javascript:ShowAddMaintenanceTypeModal('CLASS', this);" title="Add/Edit Class"></i>
                        </div>
                    </fieldset>
                </div>
                                ...
                                <tbody id="tbSupport" data-bind="foreach: addEquipmentViewModel.SupportInfoList" class="tbody">
                                    <tr data-bind="attr: { id: 'trSupportInfoList_' + ($index()) }">
                                        ...
                                        <td class="nowrap" style="width: 13%;">
                                            <input type="text" maxlength="200" autocomplete="off" class="form-control  font-small"
                ...
                <fieldset class="col-xs-12 bottom-gap">
                    <button id="btnCloseEquipment" class="btn btn-cancel btn-sm pull-xs-right heading-gap medium-leftmargin" onclick="ClearEquipmentInfo(true); return false;"><%=GetGlobalResourceObject("Equipment_Resource", "cancel")%></button>
            ...
            <div class="col-xs-12 col-lg-4 pull-xs-right">
                <div class="rside-box">
                    ...
                    <fieldset>
                        ...
                        <fieldset class="p-x-0 col-xs-12 col-lg-7">
                            <select class="form-control-sm nopadding select2 " id="drpFilterFunctionalLocation"
                                data-bind="options: FunctionalLocationArray, optionsText: 'DisplayName', optionsValue: 'TypeValue', value: SelectFunctionalLocationFilter, event: { change: DrpDownFunctionalLocationFlag() == true ? function () { LoadAllEquipmentInfo(jQuery.AddEquipmentNamespace.PagerData) } : '' }">
                            </select>
                        </fieldset>
                    </fieldset>
                    <fieldset style="border-bottom: 1.5px solid #eee">
                        ...
                        <input type="text" id="txtSearchEquipment" maxlength="50" data-bind="event: { keyup: DrpDownFunctionalLocationFlag() == true ? function () { LoadAllEquipmentInfo(jQuery.AddEquipmentNamespace.PagerData) } : '' }" placeholder="Search Equipment" class="form-control-sm col-xs-12 col-lg-7 m-b-0" />
                    </fieldset>

                    <fieldset class="tiny-padding p-b-0">
                        <input type="hidden" id="hdnSortbyNameValue" />
                        <input type="hidden" runat="server" enableviewstate="false" value="15" id="hdnEquipmentPageSize" />
                        <a id="sortEquipment" runat="server" enableviewstate="false" style="white-space: nowrap;" class="cursor-pointer center-align black tiny-rightmargin pull-xs-right"
                             data-bind="visible: EquipmentInfoArray().length > 0 ? true : false">
                            <span class="underline gray"><%=GetGlobalResourceObject("Equipment_Resource", "sortByName")%></span><i class="tiny-leftmargin cursor-pointer gray "></i></a>
                    ...
                    <span data-bind="text: EquipmentInfoArray().length > 0 ? '' :'<%=GetGlobalResourceObject("Equipment_Resource", "noRecordFound")%>'" class="font-small text-xs-center tiny-leftmargin gray center-align"></span>
                    </div>
                </div>
            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <td colspan="10">
                                                    <div data-bind="html: ModelPagerContent" class="pagination m-a-0 col-xs-12"></div>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
