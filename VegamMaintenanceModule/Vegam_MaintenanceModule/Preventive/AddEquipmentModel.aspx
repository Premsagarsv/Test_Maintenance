    ...
    <div class="col-xs-12">
        <div class="row">
                ...
                <fieldset class="addNewMeasuringPoint rside-box">
                    <div class="tiny-padding col-xs-12" style="border-bottom: 1.5px solid #eee;">
                        ...
                        <fieldset class="push-down">
                            ...
                            <input type="text" class="form-control-sm col-xs-12 col-lg-8 pull-xs-right gray" id="txtSearchEquipmentModel" onkeyup="LoadEquipmentModelList(jQuery.EquipmentModelNamespace.PagerData)" placeholder="<%=GetGlobalResourceObject("EquipmentModel_Resource", "searchModelName")%>" />
                        </fieldset>
                    ...
                    <fieldset class="tiny-padding p-b-0">
                        ...
                        <input type="hidden" runat="server" enableviewstate="false" value="15" id="hdnModelPageSize" />
                        <a id="sortEquipmentModel" runat="server" enableviewstate="false" style="white-space: nowrap;" class="cursor-pointer center-align black tiny-rightmargin pull-xs-right"
                             data-bind="visible: EquipmentModelList().length > 0 ? true : false">
                            <span class="underline gray"><%=GetGlobalResourceObject("EquipmentModel_Resource", "sortByName")%></span><i class="tiny-leftmargin cursor-pointer gray  "></i></a>
                        <fieldset id="fieldsetModelList" data-bind="foreach: EquipmentModelList">
                            <div class="col-xs-12 p-a-0 measuring-points bottom-gap" data-bind=" attr: { id: 'divTrash_' + TypeValue }">
                                ...
                                <label class="col-xs-8 col-lg-9 tiny-leftmargin p-l-0 m-b-0 p-b-0 cursor-pointer ellipsis nowrwap" style="border-bottom: 1px solid #ccc" 
            ...
            <div id="divEquipmentModelInfo" class="col-xs-12 col-lg-8 push-down p-x-0">
                <div class="info-block m-r-0 m-b-1" style="padding: 2px" data-bind="visible: (!IsEmptylist() || jQuery.EquipmentModelNamespace.ModelID > 0)">
                    <fieldset>
                        <span class="pull-xs-right">
                            <button id="buttonlnkMeasuringPoint" class="btn btn-mini btn-primary" runat="server" enableviewstate="false" onclick="ViewAdditionalInfoLinks('P'); return false;" ><%=GetGlobalResourceObject("EquipmentModel_Resource", "addViewMeasuringPoint")%></button>
                            <button id="buttonlnkDocuments" class="btn btn-mini btn-success" runat="server" enableviewstate="false" onclick="ViewAdditionalInfoLinks('D'); return false;" ><%=GetGlobalResourceObject("EquipmentModel_Resource", "addViewDocumentsAndImages")%></button>
                        </span>
                    </fieldset>
                </div>
                ...
                <div class="col-xs-12 col-lg-7 col-xl-7 p-x-0">
                    ...
                    <fieldset>
                        ...
                        <textarea id="txtEquipmentModelDesc" maxlength="1000" class="form-control-sm col-xs-12 col-lg-7 col-xl-8 font-small" data-bind="textInput: ModelDescription, attr: { onkeydown: 'return checkTextAreaMaxLength(this,event,1000)' }"></textarea>
                    </fieldset>
                    <fieldset>
                        ...
                        <div class="col-xs-12 col-lg-7 col-xl-8 p-a-0">
                            ...
                            <i class="fa blue cursor-pointer fa-plus-circle fa-2x pull-xs-right" onclick="javascript:ShowAddMaintenanceTypeModal('MANUFACTURER');" title="Add/Edit Manufacture"></i>
                        </div>
                    </fieldset>
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="col-xs-12 col-lg-7 col-xl-8 p-a-0">
                            ...
                            <i class="fa blue cursor-pointer fa-plus-circle fa-2x pull-xs-right" onclick="javascript:ShowAddMaintenanceTypeModal('TYPE');" title="Add/Edit Type"></i>
                        </div>
                    </fieldset>
                    <fieldset>
                        ...
                        <div class="col-xs-12 col-lg-7 col-xl-8 p-a-0">
                            ...
                            <i class="fa blue cursor-pointer fa-plus-circle fa-2x pull-xs-right" onclick="javascript:ShowAddMaintenanceTypeModal('CLASS');" title="Add/Edit Class"></i>
                        </div>
                    </fieldset>
