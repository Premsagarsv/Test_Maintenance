...
{
    public partial class ConfigureSpareParts : iPAS_Base.BasePage
    {
        int siteID = 0;
        int userID = 0;
        int accessLevelID = 0;
        ...
        private AccessType ValidateUserPrivileges(int siteID, int accessLevelID)
        {
            ...
            access = CommonBLL.ValidateUserPrivileges(siteID, this.CurrentUser.SiteID, this.CurrentUser.UserID, accessLevelID, Convert.ToInt32(Language_Resources.MaintenancePageID_Resource.Configure_SpareParts));
