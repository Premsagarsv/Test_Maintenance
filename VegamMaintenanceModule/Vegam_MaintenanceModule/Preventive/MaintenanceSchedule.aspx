                                ...
                                <tbody data-bind="foreach: SparePartInfoList" id="tbodySparePartInfoList">
                                    <tr>
                                        <td style="max-width:500px !important">
                                            <select class="form-control-sm col-xs-12 col-md-10" data-bind="enable: !IsSOPSparePart() ,event: { change: OnSparePartChange }, options: $root.SparePartMaterialList, optionsText: 'DisplayName', optionsValue: 'MaterialNumber', optionsCaption: '<%=GetGlobalResourceObject("MaintenanceSchedule_Resource", "select")%>'">
                                            </select>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control-sm col-xs-12 col-md-10" onpaste="return OnValuePaste(this,event,10,3);" data-bind="enable: !IsSOPSparePart(), textInput: Quantity" onkeypress="return ValidateDecimalValueForInput(this,event,10,3);"/>
                                        </td>
                                        <td>
