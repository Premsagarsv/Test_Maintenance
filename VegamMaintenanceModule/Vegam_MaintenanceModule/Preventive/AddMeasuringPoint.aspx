...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
                ...
                <div class="rside-box">
                    <fieldset class="addNewMeasuringPoint info-block box-shadow bg-transparent" id="divMeasuringPointList">
                        <div class="tiny-padding col-xs-12 bottom-gap" style="border-bottom: 1.5px solid #eee;">
                                    ...
                                    <fieldset data-bind="visible: FdEquipmentFilter">
                                        ...
                                        <div class="col-xs-12 col-lg-6 p-x-0">
                                            <select class="form-control-sm Parameters-Select select2" id="drpFilterEquipment"
                                                data-bind="options: EquipmentList, optionsText: 'DisplayName', optionsValue: 'TypeValue', value: SelectEquipmentFilter, attr: { id: 'drpFilterEquipment' }, event: { change: ChangeEventBind() == true ? function () { LoadMeasuringPointList(jQuery.MeasuringPointNameSpace.MeasuringPointPagerData,jQuery.MeasuringPointNameSpace.MeasuringPointDataTyeInfo.Equipment) } : '' }">
                                            </select>
                                        </div>
                                    </fieldset>
                                    <fieldset data-bind="visible: FdEquipModelFilter">
                                        ...
                                        <div class="col-xs-12 col-lg-6 p-x-0">
                                            <select class="form-control-sm Parameters-Select select2" id="drpFilterEquipModel"
                                                data-bind="options: EquipmentModelList, optionsText: 'DisplayName', optionsValue: 'TypeValue', value: SelectEquipmentModelFilter, attr: { id: 'drpFilterEquipModel' }, event: { change: ChangeEventBind() == true ? function () { LoadMeasuringPointList(jQuery.MeasuringPointNameSpace.MeasuringPointPagerData,jQuery.MeasuringPointNameSpace.MeasuringPointDataTyeInfo.Equipment_Model) } : '' }">
                                            </select>
                                        </div>
                                    </fieldset>
                            ...
                            <input type="text" class="form-control-sm col-xs-12 col-lg-6  gray" id="txtSearchMeasuringPoint" onkeyup="LoadMeasuringPointList(jQuery.MeasuringPointNameSpace.MeasuringPointPagerData)" placeholder="<%=GetGlobalResourceObject("MeasuringPoint_Resource", "searchMeasuringPoint")%>" />
                            
                        </div>
                        <div class="col-xs-12 p-a-0">
                             <input type="hidden" id="hdnSortbyNameValue" />
                              <a id="sortMeasuringPoint" runat="server" enableviewstate="false" style="white-space: nowrap;" class="cursor-pointer center-align black tiny-rightmargin pull-xs-right"
                             data-bind="visible: MeasuringPointList().length > 0 ? true:false">
                            <span class="underline gray"><%=GetGlobalResourceObject("MeasuringPoint_Resource", "sortByName")%></span><i class="tiny-leftmargin cursor-pointer gray  "></i></a>
                        <fieldset class="tiny-padding col-xs-12 p-t-0"  data-bind="foreach: MeasuringPointList">
            ...
            <div id="divMeasuringPointUC" class="col-xs-12 col-lg-8 push-down">
                ...
                <div id="divUrlLink" class="info-block tiny-padding p-y-0 m-r-0 m-b-1 hide">                 
                    ...
                    <button  id="lnkFLocation" class="btn btn-mini btn-primary hide" runat="server" enableviewstate="false" onclick="ViewAdditionalInfoLinks('L'); return false;"><%=GetGlobalResourceObject("MeasuringPoint_Resource", "addViewFunctionalLocation")%></button>
                    <button id="lnkEquipmentInfo" class="btn btn-mini btn-success hide" runat="server" enableviewstate="false" onclick="ViewAdditionalInfoLinks('E'); return false;"></button>
                        </span>
                        </fieldset>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-lg-7 col-xl-8 p-x-0">
                    ...
                    <fieldset data-bind="visible: FdGenerateCode">
                        ...
                        <input id="txtMeasuringCode" maxlength="10" style="text-transform: uppercase;" runat="server" type="text" class="form-control-sm col-xs-12 col-lg-4 tiny-rightmargin" data-bind="attr: { 'disabled': !BtnGenerateCode() }, textInput: MeasuringCode">
                        <i class="fa fa-barcode cursor-pointer pover pull-xs-left tiny-rightmargin" data-bind="visible: MeasuringCode() != '' ? true : false" onclick="DownloadBarcode();return false;" data-content="<%=GetGlobalResourceObject("MeasuringPoint_Resource", "downloadBarcode")%>" data-placement="top" data-original-title="" style="font-size:2.2rem;"></i>
                    ...
                    <fieldset>
                        ...
                        <i class="fa blue cursor-pointer fa-plus-circle fa-2x pull-xs-right" onclick="javascript:ShowAddMaintenanceTypeModal('MP_CATEGORY');" title="Add/Edit Category"></i>
                            </div>
                    </fieldset>
                    <fieldset>
                    ...
                    <fieldset data-bind="visible: FdSelection">
                        ...
                        <div class="col-xs-12 col-lg-7 col-xl-8 p-x-0">
                            ...
                            <select id="drpGroup" class="form-control-sm Parameters-Select select2" data-bind="options: GroupList, optionsText: 'DisplayName', optionsValue: 'TypeValue', value: SelectedGroup">
                               ...
                               <i class="fa blue cursor-pointer fa-plus-circle fa-2x pull-xs-right" onclick="javascript:ShowAddMaintenanceTypeModal('GROUPCODE');" title="Add/Edit Selection Group"></i>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="col-xs-12 bottom-gap heading-gap p-r-0">
                        <button id="btnCancelMesuringPoint" class="btn btn-sm btn-cancel pull-xs-right" onclick="ClearMeasuringPointInfo(true);return false;"><%=GetGlobalResourceObject("MeasuringPoint_Resource","cancel")%></button>
    ...
    <div id="divAddMaintenanceMasterDataModal" data-backdrop="static" data-keyboard="false" class="modal fade in ">
                                ...
                                <div id="addItem" class="hide">
                                     <fieldset>
                                        ...
                                        <input type="text" id="txtItemName" maxlength="50" class="form-control-sm col-xs-12 col-lg-5 col-xl-6" />
                                          ...
                                          <button id="btnAddItem" class="btn btn-sm btn-success tiny-rightmargin pull-xs-right" onclick="javascript:AddItemsToModal();return false;"><%=GetGlobalResourceObject("MeasuringPoint_Resource","addItem")%></button>
                                         </fieldset>
                            ...
                            <table id="tableMaintTypes" class="table table-bordered">
                                ...
                                <tbody class="tbodypositionfixed" runat="server" data-bind="foreach: $root.DefaultMaintenanceTypesArray()">
                                    <tr>
                                        ...
                                        <td class="break-word" data-bind="text: DescOrItemName"></td>
                                    </tr>
                                </tbody>
                                <tfoot>
          ...
          <input type="hidden" runat="server" enableviewstate="false" value="5" id="hdnMeasuringPointPageSize" />
