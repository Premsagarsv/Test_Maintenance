    ...
    <div class="col-xs-12">
        ...
        <div class="row" id="divToolsInfo">
            <div class="col-xs-12 col-md-7 table-with-heading">
                <div class="font-small bold">
                   <%=GetGlobalResourceObject("ToolInfo_Resource", "configureToolsMessage")%>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered nobox-shadow noborder-radius">
                        <thead>
                            <tr>
                                <th style="width: 15%"><%=GetGlobalResourceObject("ToolInfo_Resource", "action")%>
                                </th>
                                <th style="width: 30%"><%=GetGlobalResourceObject("ToolInfo_Resource", "tools")%>
                                </th>
                                <th id="thDescription" style="width: 55%"  runat="server" enableviewstate="false" class="bg-graylight cursor-pointer">
                                     <span class="underline"><%=GetGlobalResourceObject("ToolInfo_Resource", "description")%>
                        ...
                        <tbody id="tbTools" data-bind="foreach: ToolsInfoArray()">
                            <tr>
                                ...
                                <td data-bind="text: ToolDesc " class="break-word"></td>
