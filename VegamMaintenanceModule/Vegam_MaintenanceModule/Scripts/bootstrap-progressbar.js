!function ($) { 
    ...
    ProgressBar.prototype = {
        ...
        setPosition: function (position) {
            ...
            try {
                this.element.find('.bar-info').css('width', this.percent + "%");
            } finally {
    ...
    DRPGlobal.template = '<div class="progress"><div class="bar bar-info progress-bar progress-bar-info" style="width: 0%;"></div></div>';
