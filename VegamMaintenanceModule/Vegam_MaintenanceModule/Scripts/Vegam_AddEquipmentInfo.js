...
function ModalReferModelMasterData() {
    ...
    //modal focus
    var modalDivId = jQuery("#divModalEquipmentModel")
...
function modalVisible(modalDiv) {
    modalVisibleTimeOut  = setInterval(function () {
        var input = jQuery(modalDiv).find('input:visible:eq(0)');
        if (jQuery(modalDiv).is(':visible')) {
            clearTimeout(modalVisibleTimeOut);
            jQuery(input).focus();
        }
    }, 100);
} 