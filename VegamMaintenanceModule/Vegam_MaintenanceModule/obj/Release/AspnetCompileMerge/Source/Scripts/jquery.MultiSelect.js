...
(function ($) {
    ...
    function MultipleSelect($el, options) {
        ...
        this.$choice = $('<button type="button" class="ms-choice"><span class="placeholder push-down">' +
            options.placeholder + '</span><div></div></button>');
        this.$drop = $('<div class="ms-drop ' + options.position + '" style="position:absolute;"></div>');
