...
function LoadDocumentAndImagesBasicInfo(basicParam, hasFullAccess, type, equipmentID, basePath, webservicePath, uploaderPath, defaultUploadIconPath, fLocationID) {
    ...
    if (jQuery.DocumnetsAndImagesNamespace.FLocationID == 0) {
...
function BindFilterModelListOrEquipmentList() {
    ...
    jQuery.ajax({
        type: "POST",
        url: jQuery.DocumnetsAndImagesNamespace.WebServicePath + "/Vegam_MaintenanceService.asmx/GetEquipmentDetailsInfo",
        data: JSON.stringify({ equipmentFilterInfo: filterInfo }),
    ...
    jQuery.ajaxFileUpload({
        ...
        success: function (data, status) {
            ...
            if (data.documentElement.innerText != "true") {
                ...
                InsertDocumentImageVideoInfo(fileName, fileType);
                return true;
            }
        },
        complete: function () {
...
function InsertDocumentImageVideoInfo(fileName, fileType) {
    var filterInfo = {};
    filterInfo.SiteID = jQuery.DocumnetsAndImagesNamespace.BasicParam.SiteID;
    filterInfo.UserID = jQuery.DocumnetsAndImagesNamespace.BasicParam.UserID;
