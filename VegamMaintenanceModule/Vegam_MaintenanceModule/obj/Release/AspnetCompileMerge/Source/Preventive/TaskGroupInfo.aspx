...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divTaskGroup" class="col-xs-12">
        <fieldset class="info-block bottom-gap" id="divTaskGroupHeader">
            ...
            <div>
                <label class="form-control-label label-xxlarge nomarginleft"><%=GetGlobalResourceObject("TaskGroup_Resource", "taskGroupName")%></label>
                <input type="text" class="form-control-sm col-xs-12 col-lg-2" maxlength="100" data-bind="textInput: TaskGroupName" />

                <label class="form-control-label pull-xs-left tiny-leftmargin"><%=GetGlobalResourceObject("TaskGroup_Resource", "taskGroupType")%></label>
                ...
                <i class="fa blue cursor-pointer fa-plus-circle fa-2x  medium-leftmargin pull-xs-left push-down" onclick="javascript:ShowAddMaintenanceTypeModal('S' , this);" title="<%=GetGlobalResourceObject("TaskGroup_Resource", "addEditTaskGroupType")%>"></i>
                ...
                <div class="col-xs-12 col-lg-4" data-bind="html: TaskGroupErrorMsg, css: TaskGroupErrorCss"></div>
            </div>
        </fieldset>
        <div id="divTaskDetails" data-bind="css: TaskEditEnable() ? '' : 'disabled-div'">
            <div class="col-xs-12 col-md-3 p-l-0" id="divTaskGroupLeftHeader">
                <div class="p-listing box-shadow" style="min-height: 550px !important;">
                    <div class="c-newphase col-xs-12 bottom-gap">
                        <button type="button" class="pull-xs-left btn btn-sm btn-success tiny-leftmargin" data-bind="click: function () { ModelErrorMsg(''); ClearTaskInfo() }">
                            <i class="fa fa-plus-circle"></i>
                            <%=GetGlobalResourceObject("TaskGroup_Resource", "addTask")%></button>
                        <button class="pull-xs-right btn btn-sm btn-primary tiny-rightmargin" onclick="javascript:ShowAllTaskInfo();return false;">
                            <i class="fa fa-eye"></i>
            ...
            <div class="col-xs-12 col-md-9 p-r-0 bottom-gap p-l-0" id="divTaskGroupTaskDetails">
                <div>
                    <div data-bind="foreach: TaskInfoList">
                        <div class="col-xs-12 p-a-0 p-listing box-shadow bottom-gap heightcontent">
                            <div class="heading-gap" data-bind="visible: taskGroupViewModel.EnableEdit()">
                                <label class="form-control-label col-xs-12 col-md-2"><%=GetGlobalResourceObject("TaskGroup_Resource", "taskName")%></label>
                                <input type="text" class="form-control-sm col-xs-12 col-md-4" maxlength="100" data-bind="textInput: TaskName" />
                            </div>
                            <div class="border-heading" data-bind="visible: !taskGroupViewModel.EnableEdit()">
                                ...
                                <label class=""><%=GetGlobalResourceObject("TaskGroup_Resource", "taskName")%>:</label>
                            ...
                            <div class="col-xs-12 p-a-0 divElementHide">
                                <fieldset>
                                    ...
                                    <select class="form-control-sm col-xs-12 col-md-1" style="display: block" data-bind="options: taskGroupViewModel.UnitOfTimeList, optionsText: 'DisplayName', optionsValue: 'TypeValue', value: UnitOfTimeSelectedValue, visible: taskGroupViewModel.EnableEdit()">
                                    </select>
                                ...
                                <fieldset>
                                    <label class="form-control-label col-xs-12 col-md-2"><%=GetGlobalResourceObject("TaskGroup_Resource", "description")%></label>
                                    <textarea class="form-control-lg col-xs-12 col-md-4 font-small" maxlength="500" rows="4" onkeypress="return checkTextAreaMaxLength(this,event,300);" data-bind="textInput: TaskDescription, visible: taskGroupViewModel.EnableEdit"></textarea>
                                    <span class="form-control-label col-xs-12 col-md-4 font-small" style="display: inline; width: 100px; height: auto;" data-bind="text: TaskDescription, visible: !taskGroupViewModel.EnableEdit()"></span>
                                </fieldset>
                                <fieldset>
                                    ...
                                    <div class="col-xs-12 col-md-7 p-x-0 show">
                                        <textarea class="form-control-lg col-xs-12 tiny-leftmargin font-small" maxlength="1000" style="border-top-left-radius: 0px; border-top-right-radius: 0px;" rows="4" onkeypress="return checkTextAreaMaxLength(this,event,300);" data-bind="textInput: SafetyInstruction, visible: taskGroupViewModel.EnableEdit"></textarea>
                                        <span class="form-control-lg col-xs-12 tiny-leftmargin font-small" style="display: inline; border: 1px solid lightgray; border-radius: 6px; border-top-left-radius: 0px; border-top-right-radius: 0px; word-break: break-all; height: auto;"
                                ...
                                <fieldset class="col-xs-12 col-md-7 p-x-0 heading-gap tiny-rightmargin bottom-gap">
                                    <div class="col-xs-12 tiny-leftmargin borderstyling p-a-0" style="height: 30px;">
                                        ...
                                        <label class="col-xs-12 col-md-6 tiny-leftmargin p-a-0 push-down"><%=GetGlobalResourceObject("TaskGroup_Resource", "ppe")%></label>
                                    ...
                                    <div class="col-xs-12 tiny-leftmargin p-x-0 show" style="border: 1px solid lightgray; border-radius: 6px; border-top-left-radius: 0px; border-top-right-radius: 0px;">
                                        <div class="push-down bottom-gap" data-bind="foreach: TaskPPEList">
                                            <div class="col-xs-2 bottom-gap heading-gap">
                                                <i class="fa fa-2x fa-times-circle red cursor-pointer" style="position: absolute; right: -7%; top: -7%;" data-bind="click: $root.HasDeleteAccess() ? function () { RemovePPIImage(InstructionID); } : '', css: $root.HasDeleteAccess() ? '' : 'icon-muted', visible: taskGroupViewModel.EnableEdit  "></i>
                                ...
                                <fieldset class="col-xs-12 col-md-7 p-x-0 heading-gap tiny-rightmargin bottom-gap">
                                    <div class="col-xs-12 tiny-leftmargin borderstyling p-a-0" style="height: 30px;">
                                        <i class="fa blue big pull-xs-left cursor-pointer tiny-leftmargin fa-minus-circle push-down" onclick="Toggle(this);"></i>
                                        <label class="col-xs-12 col-md-6 tiny-leftmargin p-a-0 push-down"><%=GetGlobalResourceObject("TaskGroup_Resource", "tools")%></label>
                                    ...
                                    <div class="col-xs-12 tiny-leftmargin p-x-0 show" style="border: 1px solid lightgray; border-radius: 6px; border-top-left-radius: 0px; border-top-right-radius: 0px;">
                                        <div class="push-down bottom-gap" data-bind="foreach: TaskToolsList">
                                            <div class="col-xs-2 bottom-gap heading-gap">
                                                <i class="fa fa-2x fa-times-circle red cursor-pointer" style="position: absolute; right: -7%; top: -7%;" data-bind="click: $root.HasDeleteAccess() ? function () { RemoveToolsImage(InstructionID); } : '', css: $root.HasDeleteAccess() ? '' : 'icon-muted', visible: taskGroupViewModel.EnableEdit  "></i>
                                                <div data-bind="attr: { title: InstructionName }">
                                                    <img style="width: 60px; height: 60px;" data-bind="attr: { src: ImagePath }" />
                                                    <label class="pull-xs-left full-width center-align nowrap ellipsis" style="max-width: 95%" data-bind="text: InstructionName"></label>
                                                </div>
                                ...
                                <fieldset class="col-xs-12 col-md-7 p-x-0 heading-gap tiny-rightmargin bottom-gap">
                                    <div class="col-xs-12 p-a-0 borderstyling tiny-leftmargin" style="height: 30px;">
                                        ...
                                        <label class="col-xs-12 col-md-6 tiny-leftmargin p-a-0 push-down"><%=GetGlobalResourceObject("TaskGroup_Resource", "fileAndImageUpload")%></label>
                                    </div>
                                    ...
                                    <div class="col-xs-12 tiny-leftmargin p-x-0 show" style="border: 1px solid lightgray; border-radius: 6px; border-top-left-radius: 0px; border-top-right-radius: 0px;">
                                        <span class="rightmargin pull-xs-left" data-bind="foreach: DocumentOrImageList">
                                            <span class="cursor-pointer tiny-leftmargin" style="display: inline-block">
                                                <img class="pull-xs-left tiny-rightmargin heading-gap bottom-gap" data-bind="attr: { src: ThumbnailPath, title: DocumentDisplayName }, click: function () { DownloadDocumentOrImageOrVideoInfo($data); return false; }" style="width: 50px; height: 55px;">
                                ...
                                <fieldset class="col-xs-12">
                                    <input type="checkbox" class="pull-xs-left heading-gap" onchange="ChkEnterRemarkChanged(this);return false;" data-bind="checked: IsEnabledEnterRemark, enable: taskGroupViewModel.EnableEdit">
                                    <label class="form-control-label col-xs-12 col-md-3"><%=GetGlobalResourceObject("TaskGroup_Resource", "enableToEnterRemark")%></label>
                                    <div data-bind="visible: IsEnterRemarkVisible">
                                        ...
                                        <label class="form-control-label col-xs-12 col-md-3"><%=GetGlobalResourceObject("TaskGroup_Resource", "isMandatory")%></label>
                                    </div>
                                </fieldset>
                                <fieldset class="col-xs-12">
                                    <input type="checkbox" class="pull-xs-left  heading-gap" onchange="ChkTakePictureChanged(this);return false;" data-bind="checked: IsEnabledTakePicture, enable: taskGroupViewModel.EnableEdit">
                                    <label class="form-control-label col-xs-12 col-md-3"><%=GetGlobalResourceObject("TaskGroup_Resource", "enableToTakePicture")%></label>
                                ...
                                <fieldset class="col-xs-12">
                                    <label class="form-control-label col-xs-12 col-md-4 blue cursor-pointer" data-bind="visible: taskGroupViewModel.EnableEdit" onclick="javascript:AddMoreParameter();return false;"><%=GetGlobalResourceObject("TaskGroup_Resource", "addMore")%></label>
                                </fieldset>
                                    ...
                                    <table class="table nobox-shadow noborder-radius m-b-0 main-table table-bordered bottom-gap col-xs-10" style="border: none;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><%=GetGlobalResourceObject("TaskGroup_Resource", "selectionCode")%></th>
                                        ...
                                        <tbody data-bind="foreach: ParameterInfoList">
                                            <tr>
                                                <td>
                                                    <input type="text" maxlength="150" class="form-control-sm col-xs-12 col-md-10" data-bind="textInput: ParameterName, visible: taskGroupViewModel.EnableEdit" />
                                                    <span class="form-control-sm col-xs-12 col-md-10" data-bind="text: ParameterName, visible: !taskGroupViewModel.EnableEdit()"></span>
                                                </td>
                                                <td>
                                                    <input type="checkbox" class=" col-xs-12 col-md-10 heading-gap" data-bind="checked: IsParameterMandatory, enable: taskGroupViewModel.EnableEdit()" />
                                                </td>
                                                <td>
                    ...
                    <button type="button" class="btn btn-sm btn-success pull-xs-right heading-gap m-r-1 bottom-gap" onclick="javascript:SaveTaskInformation();return false;" data-bind="visible: taskGroupViewModel.EnableEdit() "><%=GetGlobalResourceObject("TaskGroup_Resource", "save")%></button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row p-l-2">
                    <div data-bind="foreach: InstructionSelectionList">
                        <div class="col-xs-12 col-md-3 col-xl-2 p-l-0" style="width: 23% !important;">
                            ...
                            <label class="pull-xs-left full-width center-align ellipsis nowrap" data-bind="text: InstructionName" style="max-width: 95%"></label>
                        </div>
                    </div>
