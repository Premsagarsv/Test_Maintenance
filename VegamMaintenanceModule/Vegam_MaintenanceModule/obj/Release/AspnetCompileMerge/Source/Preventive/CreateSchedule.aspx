...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divScheduleInfo" style="min-height: 100vh">
        <div class="col-xs-12 col-lg-3 lside-box">
        ...
        <div class="col-xs-12 col-lg-9 p-t-1 rside-box">
            <fieldset>
                <label class="pull-xs-left form-control-label p-l-0"><%=GetGlobalResourceObject("CreateSchedule_Resource", "occursEvery")%></label>
            ...
            <fieldset data-bind="visible: IsWeekly">
                <label class="full-width gray bold"><%=GetGlobalResourceObject("CreateSchedule_Resource", "selectDay")%></label>
                <div data-bind="foreach: WeekDay" class="btn-group">
            ...
            <fieldset data-bind="visible: IsMonthly" class="leftmargin push-down">
                <div class="radio p-l-1 pull-xs-left push-down">
                    <input type="radio" name="monthOption" value="1" data-bind="checked: MonthOption">
                </div>
                <label class="pull-xs-left form-control-label p-l-0"><%=GetGlobalResourceObject("CreateSchedule_Resource", "recurOnDays")%></label>
            ...
            <fieldset data-bind="visible: IsMonthly" class="leftmargin heading-gap">
                <div class="radio p-l-1 pull-xs-left push-down">
                    <input type="radio" name="monthOption" value="2" data-bind="checked: MonthOption">
                </div>
                <label class="pull-xs-left form-control-label p-l-0"><%=GetGlobalResourceObject("CreateSchedule_Resource", "occursOnThe")%></label>
            ...
            <fieldset data-bind="visible: IsYearly" class="leftmargin heading-gap">
                <div class="radio p-l-1 pull-xs-left push-down">
                    <input type="radio" name="yearOption" value="1" data-bind="checked: YearOption">
                </div>
                <label class="pull-xs-left form-control-label p-l-0"><%=GetGlobalResourceObject("CreateSchedule_Resource", "on")%></label>
            ...
            <fieldset data-bind="visible: IsYearly" class="leftmargin heading-gap">
                <div class="radio p-l-1 pull-xs-left push-down">
                    <input type="radio" name="yearOption" value="2" data-bind="checked: YearOption">
                </div>
                <label class="pull-xs-left form-control-label p-l-0"><%=GetGlobalResourceObject("CreateSchedule_Resource", "on")%></label>
                <div data-bind="template: { name: 'multiselect-dropdown-template', data: MonthPosition }"></div>
                <div data-bind="template: { name: 'multiselect-dropdown-template', data: WeekDay }"></div>
            ...
            <fieldset id="divRangeOfRecurrence">
                <label class="full-width gray bold"><%=GetGlobalResourceObject("CreateSchedule_Resource", "recurrencePattern")%></label>
                ...
                <div class="pull-xs-left medium-leftmargin">
                    <fieldset>
                        <div class="radio p-l-1 pull-xs-left push-down">
                            <input type="radio" name="endOption" value="1" data-bind="checked: EndOption">
                        </div>
                        <label class="pull-xs-left form-control-label p-l-0 label-large nomarginleft"><%=GetGlobalResourceObject("CreateSchedule_Resource", "endAfter")%></label>
                        <input type="text" class="form-control-sm col-xs-12 col-lg-2 tiny-rightmargin" data-bind="value: EndNumOccurrence" maxlength="3" onkeypress="return isNumberKey(event)" />
                    ...
                    <fieldset>
                        <div class="radio p-l-1 pull-xs-left push-down">
                            <input type="radio" name="endOption" value="2" data-bind="checked: EndOption">
                        </div>
                        <label class="pull-xs-left form-control-label p-l-0 label-large nomarginleft"><%=GetGlobalResourceObject("CreateSchedule_Resource", "endBy")%></label>
                        <input type="text" class="datecontrol form-control-sm col-xs-12 col-lg-4" id="txtEndDate" />
                    </fieldset>
                </div>
            </fieldset>
            <fieldset class="heading-gap">
                <label class="pull-xs-left form-control-label p-l-0 tiny-rightmargin"><%=GetGlobalResourceObject("CreateSchedule_Resource", "setReminderNotificationMail")%></label>
            ...
            <fieldset>
                <span id="spnErrorMessage" class="red"></span>
            </fieldset>
        </div>
        <script type="text/html" id="multiselect-dropdown-template">
            <div class="col-xs-1 p-a-0 tiny-leftmargin">
                <div class="functiondropdown cursor-pointer col-xs-12">
                    <span><%=GetGlobalResourceObject("CreateSchedule_Resource", "select")%></span>
                    <i class="icontag fa big pull-xs-right fa-caret-down i-opacity"></i>
                </div>
                <div class="drpdownbody col-xs-12 hide_ele" style="margin-top: 36px;">
                    <div style="padding: 4px 0px 4px 4px !important;">
                    ...
                    <ul class="p-x-0 ulField drpDownList pull-xs-left heading-gap col-xs-11 tiny-leftmargin m-b-0" data-bind="foreach: $data">
                        <li class="">
                            <span class="li col-xs-12" data-bind="css: {selectedlist: IsSelected}">
                                <input type="checkbox" class="tiny-leftmargin tiny_push-down pull-xs-left tiny-rightmargin" data-bind="checked: IsSelected" /><span data-bind="text: Value"></span></span>
                        </li>
                    </ul>
                </div>
            </div>
