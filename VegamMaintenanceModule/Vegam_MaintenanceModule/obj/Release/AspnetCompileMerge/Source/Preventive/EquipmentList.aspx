    ...
    <div class="pro-plan col-xs-12" id="divEquipmentInfo">
        ...
        <fieldset id="fdDownloadAndUpload" class="heading-gap">
            ...
            <div id="spnDownloadAndUpload" class="hide">
                ...
                <button type="button" id="btnUploadExcel" runat="server" class="btn btn-default btn-sm  tiny-rightmargin bottom-gap">
                    <i class="fa fa-upload tiny-rightmargin"></i><%=GetGlobalResourceObject("Equipment_Resource", "uploadExcel")%></button>
                <button class="btn btn-default btn-sm tiny-rightmargin bottom-gap" id="btnDownload" onclick="DownloadAllEquipmentInfo();return false;">
        ...
        <fieldset class="info-block bottom-gap">
            ...
            <div class="">
                ...
                <input id="txtSearchEquipment" type="text" maxlength="20" class="form-control-sm in-input">
                ...
                <p class="text-danger font-small col-xs-12 m-b-0 p-x-0 tiny-leftmargin" id="spnSearchError"></p>
        ...
        <div class="relative">
            <fieldset id="fieldEquipments" class="info-block p-a-0" style="border-radius: 5px" data-bind="foreach: EquipmentInfoArray">
                <div data-bind="click: function () { AddUpdateNewEquipment(EquipmentID); }, attr: { class: 'col-xs-12 col-lg-6 img-border tiny-padding cursor-pointer' } ">
                    ...
                    <div class="col-xs-7 col-lg-6 bold p-l-0">
                        <label class="bold full-width" data-bind="text: EquipmentName"></label>
                        <label class="bold full-width" data-bind="text: FunctionalLocationName"></label>
                        <label class="gray" data-bind="text: EquipmentDesc"></label>
                    </div>
                    <div class="col-xs-7 col-lg-3 p-a-0">
                        <div class="col-xs-12 p-a-0">
                            <label class="gray m-b-0 pull-xs-right"><%=GetGlobalResourceObject("FunctionalLocation_Resource", "updatedOn")%> :</label>
                            <label class="gray pull-xs-right tiny-rightmargin" data-bind="text: UpdatedOn"></label>
                        </div>
                        <div class="col-xs-12 p-a-0">
                            <label class="gray pull-xs-right tiny-rightmargin" data-bind="text: CategoryName"></label>
                        </div>
                        <div class="col-xs-12 p-a-0 ">
                            <label class="gray pull-xs-right tiny-rightmargin" data-bind="text: ClassName"></label>
                        </div>
                        <fieldset class="col-xs-12 p-a-0">
                            <i class="fa fa-trash-o text-danger v-icon cursor-pointer pull-xs-right tiny-rightmargin" data-bind="click: $root.HasDeleteAccess ? function () { DeleteEquipmentClick(EquipmentID, event); } : '', attr: BindIconAttributes($root.HasDeleteAccess)" title="Delete"></i>
                            <i class="fa fa-edit text-info v-icon cursor-pointer pull-xs-right tiny-rightmargin" data-bind="click: function () { AddUpdateNewEquipment(EquipmentID); } " title="Edit"></i>
                        </fieldset>
                    </div>
                </div>
            </fieldset>
