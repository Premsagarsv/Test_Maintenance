        ...
        <fieldset id="fieldFunctionalLocations" class="info-block p-a-0" style="border-radius: 5px" data-bind="foreach: FunctionalLocationInfoArray">
             <div  data-bind="click: function () { AddUpdateNewFunctionalLoaction(FunctionalLocationID); } , attr: { class: 'col-xs-12 col-lg-6 img-border tiny-padding cursor-pointer'} ">
                ...
                <div class="col-xs-7 col-lg-6 bold p-l-0">
                    ...
                    <label class="gray" data-bind="text: FunctionalLocationDesc"></label>
                </div>
                <div class="col-xs-7 col-lg-3 p-a-0">
                    ...
                    <label class="gray pull-xs-right" data-bind="text: FunctionalLocationUpdatedOn"></label>
                    <fieldset class="col-xs-12 p-a-0">
                        <i class="fa fa-trash-o text-danger v-icon cursor-pointer tiny-rightmargin pull-xs-right" data-bind="attr: { id: 'iconDelete_' + FunctionalLocationID }, click: $root.HasDeleteAccess ? function () { DeleteLocationInfoClick(FunctionalLocationID, event); } : '', attr: BindIconAttributes($root.HasDeleteAccess)" title="Delete"></i>
