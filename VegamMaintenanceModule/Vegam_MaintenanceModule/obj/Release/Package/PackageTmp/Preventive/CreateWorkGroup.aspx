...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-xs-12 push-down p-x-0 bottom-gap" id="divWorkGroup">
        <fieldset>
            <legend class="search-legend cursor-pointer"><i class="fa fa-caret-right tiny-rightmargin"></i><%=GetGlobalResourceObject("WorkGroup_Resource", "downloadAndUpload")%></legend>
            <div class="hide">
                <button class="btn btn-default btn-sm tiny-rightmargin bottom-gap tiny-leftmargin d-m-left"
                    ...
                    <i class="fa fa-download tiny-rightmargin"></i><%=GetGlobalResourceObject("WorkGroup_Resource", "downloadTemplate")%>
                </button>
                <button type="button" class="btn btn-default btn-sm  tiny-rightmargin bottom-gap"
                    runat="server" id="btnUploadExcel" onclick="ShowUploadDiv();return false;" enableviewstate="false">
                    <i class="fa fa-upload tiny-rightmargin"></i><%=GetGlobalResourceObject("WorkGroup_Resource", "upload")%>
                </button>
                <button class="btn btn-default btn-sm tiny-rightmargin bottom-gap" id="btnDownloadExcel" onclick="DownloadAllWorkGroupInfo();return false;">
                    <i class="fa fa-download tiny-rightmargin"></i><%=GetGlobalResourceObject("WorkGroup_Resource", "downloadWorkGroupInfo")%>
                </button>
        ...
        <div id="divWorkGroupList" class="col-xs-12 col-lg-4 pull-xs-right bottom-gap push-down p-r-0">
            <fieldset class="rside-box">
                <div class="tiny-padding col-xs-12" style="border-bottom: 1.5px solid #eee;">
                    <fieldset class="push-down">
                        ...
                        <input type="text" class="form-control-sm col-xs-12 col-lg-7 gray" id="txtSearchWorkGroupName" onkeyup="LoadWorkGroupList(jQuery.WorkGroupNameSpace.PagerData)" placeholder="<%=GetGlobalResourceObject("WorkGroup_Resource", "searchWorkGroup")%>" />
                    </fieldset>
                </div>
                <fieldset class="tiny-padding p-b-0">
                    <input type="hidden" id="hdnSortbyNameValue" />
                    <a id="sortWorkGroup" runat="server" enableviewstate="false" style="white-space: nowrap;" class="cursor-pointer center-align black tiny-rightmargin pull-xs-right"
                        data-bind="visible: MasterDataInfoList().length > 0 ? true : false">
                        <span class="underline gray"><%=GetGlobalResourceObject("WorkGroup_Resource", "sortByName")%></span><i class="tiny-leftmargin cursor-pointer gray  "></i></a>
            ...
            <input type="hidden" runat="server" enableviewstate="false" value="5" id="hdnWorkGroupPageSize" />
        ...
        <div id="divWorkGroupInfoList" class="col-xs-12 col-sm-12 col-lg-8 rside-box push-down">
            <fieldset class="heading-gap">
                <label class="form-control-label col-xs-12 col-lg-3 col-xl-2"><%=GetGlobalResourceObject("WorkGroup_Resource", "workGroupName")%></label>
            ...
            <fieldset class="bottom-gap ">
                <label class="form-control-label col-xs-12 col-lg-3 col-xl-2"><%=GetGlobalResourceObject("WorkGroup_Resource", "description")%></label>
            ...
            <label class="bold"><%=GetGlobalResourceObject("WorkGroup_Resource", "addMembersMessage")%></label>
                        ...
                        <table id="tblAssignee" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center-align nowrap" style="width: 13%;">
                                    ...
                                    <th class="center-align nowrap" style="width: 12%;"> <%=GetGlobalResourceObject("WorkGroup_Resource", "action")%>
                                    </th>
                                </tr>
                            </thead>
                        ...
                        <table id="tblReportingTo" class="table table-bordered m-b-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center-align nowrap" style="width: 12%;">Action
                                    </th>
                                </tr>
                            </thead>
            ...
            <div class="col-xs-12 push-down">
                <button id="btnCancelWorkGroup" onclick="ClearWorkGroupInfo(true); return false;" class="btn btn-sm btn-cancel pull-xs-right tiny-rightmargin"><%=GetGlobalResourceObject("WorkGroup_Resource", "cancel")%></button>
