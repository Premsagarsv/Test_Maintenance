                        ...
                        <div class="col-xs-12 ">
                            <div id="divSpecificationList" class="rightmargin pull-xs-left" data-bind="visible: viewDocumnetsAndImagesModal.SpecificationDocumentsList().length > 0, foreach: viewDocumnetsAndImagesModal.SpecificationDocumentsList">
                                <div class="cursor-pointer tiny-leftmargin p-a-0" style="display: inline-block; width: 70px">
                                    ...
                                    <i class="fa fa-times-circle-o font-big cursor-pointer red pull-xs-right push-down" data-bind="click: ($root.HasFullAccess && !IsModelDocument) ? function () { DeleteDocumentOrImageOrVideoInfo($data); return false; } : '', attr: $root.HasFullAccess ? { 'disabled': IsModelDocument } : BindIconAttributes($root.HasFullAccess)"></i>
                                    <label data-bind="attr: { id: 'lbl_' + DocumentID, title: DocumentDisplayName }, text: DocumentDisplayName" class="center-align full-width" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"></label>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12 ">
                            <div id="divDoumentsList" class="rightmargin pull-xs-left" data-bind="visible: viewDocumnetsAndImagesModal.ManualDocumentsList().length > 0, foreach: viewDocumnetsAndImagesModal.ManualDocumentsList">
                                <div class="cursor-pointer tiny-leftmargin p-a-0" style="display: inline-block; width: 70px">
                                    <img class="full-width center-align heading-gap" data-bind="attr: { src: ThumbnailPath, title: DocumentDisplayName }, click: function () { DownloadDocumentOrImageOrVideoInfo($data); return false; }" style="width: 50px; height: 55px;">
                                    <i class="fa fa-times-circle-o font-big cursor-pointer red pull-xs-right push-down" data-bind="click: ($root.HasFullAccess && !IsModelDocument) ? function () { DeleteDocumentOrImageOrVideoInfo($data); return false; } : '', attr: $root.HasFullAccess ? { 'disabled': IsModelDocument } : BindIconAttributes($root.HasFullAccess)"></i>
                                    <label class="center-align full-width" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" data-bind="attr: { id: 'lbl_' + DocumentID, title: DocumentDisplayName }, text: DocumentDisplayName"></label>
                                </div>
                            </div>
                            <span class="heading-gap  relative medium-rightmargin pull-xs-left bottom-gap">
                        ...
                        <div class="col-xs-12 ">
                            <div id="divImagesList" class="rightmargin pull-xs-left" data-bind="visible: viewDocumnetsAndImagesModal.ImagesAndVideosList().length > 0, foreach: viewDocumnetsAndImagesModal.ImagesAndVideosList">
                                <div class="cursor-pointer tiny-leftmargin p-a-0" style="display: inline-block; width: 70px">
                                    ...
                                    <%--</a>--%>
                                    <i class="fa fa-times-circle-o font-big cursor-pointer red pull-xs-right push-down" data-bind="click: ($root.HasFullAccess && !IsModelDocument) ? function () { DeleteDocumentOrImageOrVideoInfo($data); } : '', attr: $root.HasFullAccess ? { 'disabled': IsModelDocument } : BindIconAttributes($root.HasFullAccess)"></i>
                                    <label class="center-align full-width" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" data-bind="attr: { id: 'lbl_' + DocumentID, title: DocumentDisplayName }, text: DocumentDisplayName"></label>
                                </div>
                            </div>
                            <span class="heading-gap relative medium-rightmargin pull-xs-left bottom-gap">
