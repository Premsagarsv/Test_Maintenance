<%@ Page Title="" Language="C#" MasterPageFile="~/Vegam-Responsive.Master" AutoEventWireup="true" CodeBehind="MaintenanceIndex.aspx.cs" Inherits="Vegam_MaintenanceModule.MaintenanceIndex1" %>
    ...
    <div class="col-xs-12">
        <div class="col-xs-12">
            <div class="col-xs-12 col-sm-6 col-lg-4 col-xl-3 cursor-pointer p-r-0 hbox" style="display: block;">
                <a id="lnkMaintenanceMasterData" runat="server" enableviewstate="false">
                    <div class="outer-rect-orange">
                        <div class="col-xs-4 p-a-0">
                            <div class="outer-circle-orange p-a-0">
                                <div class="inner-circle-orange">
                                    <img src="<%= ConfigurationManager.AppSettings["MaintImagePath"].TrimEnd('/') %>/Styles/Images/master_data_setup.png"
                                        alt="Configure Maintenance" class="img-margin">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-8 p-r-0">
                            <span class="form-control-label bold label-margin col-xs-12"><%=GetGlobalResourceObject("MaintenanceIndex_Resource", "setupData")%></span>
                            <span class="form-control-label p-a-0 pull-xs-left col-xs-12 label-size"><%=GetGlobalResourceObject("MaintenanceIndex_Resource", "setupDataDescription")%></span>
                        </div>
                        ...
                        <div class="col-xs-4 p-a-0">
                            <div class="outer-circle-blue p-a-0">
                                <div class="inner-circle-blue">
                                    <img src="<%= ConfigurationManager.AppSettings["MaintImagePath"].TrimEnd('/') %>/Styles/Images/preventive_workorder.png" class="img-margin"
                                        alt="Maintenance Schedule" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-4 p-a-0">
                            <div class="outer-circle-dark-org p-a-0">
                                <div class="inner-circle-dark-org">
                                    <img src="<%= ConfigurationManager.AppSettings["MaintImagePath"].TrimEnd('/') %>/Styles/Images/preventive_checklist.png" class="img-margin"
                                        alt="Maintenance Schedule" />
                                </div>
                            </div>
                        </div>
