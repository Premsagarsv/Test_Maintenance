...
{
    /// <summary>
    /// Summary description for EquipmentUploadHandler
    /// </summary>
    public class EquipmentUploadHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                else
                {
                    ...
                    logFile = BLL.MaintenanceBLL.UploadEquipmentInfoExcel(basicParam, tempSave, insideFolderName);
