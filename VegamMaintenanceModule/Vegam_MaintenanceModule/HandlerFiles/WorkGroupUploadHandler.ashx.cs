...
{
    /// <summary>
    /// Summary description for WorkGroupUploadHandler
    /// </summary>
    public class WorkGroupUploadHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                else
                {
                    ...
                    logFile = BLL.MaintenanceBLL.UploadExcelWorkGroupInfo(basicParam, tempSave);
