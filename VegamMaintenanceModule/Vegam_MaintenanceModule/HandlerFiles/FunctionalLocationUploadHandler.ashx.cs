...
{
    /// <summary>
    /// Summary description for FunctionalLocationUploadHandler
    /// </summary>
    public class FunctionalLocationUploadHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                else
                {
                    ...
                    logFile = BLL.MaintenanceBLL.UploadFunctionalLocationInfoExcel(basicParam, tempSave, insideFolderName);
